...
const Event = {
    ...
    SET_BLEND:     'berkut-player-manager:set-blend',
    SET_OPACITY:   'berkut-player-manager:set-opacity'
}
...
const PlayerManager = function () {
    ...
    ipcMain.on(Event.SET_BLEND, (event, index, blend) => { this._players[index].blend = blend })
    ipcMain.on(Event.SET_OPACITY, (event, index, opacity) => {
        this._players[index].opacity = opacity
    })
}
